...
int main()
{
    kolejka nowa;
    int opcja=7;
    string imiona[] = { "Arek", "Karol", "Pawel","Marcin","Darek", "Ela","Jan","Kuba","Karolina","Piotr", "Julek" };//baza osob do losowania
    string nazwiska[] = { "Nowak","Jantas","Konieczny","Jantas1","Konieczny2","Jantas2","Nowak2","Marciniak2" };//baza osob do losowania
